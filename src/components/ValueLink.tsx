...
const ValueLink: React.FC<Props> = ({ title, url, value }: Props) => {
  return (
    <div className='flex group transition ease-in-out border border-cyan rounded-md hover:bg-tiffany-blue-500 hover:border-tiffany-blue-500 hover:drop-shadow-xl w-52'>
